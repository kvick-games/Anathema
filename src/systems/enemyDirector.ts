interface EnemyDirectorDependencies {
  enemies: any[];
  spawnPoints: any[];
  player: any;
  hud: any;
  ...
  makeEnemy: (x: number, z: number, typeName?: string, tier?: number) => void;
  updateMusic: (force?: boolean) => void;
  applyGravity: (entity: any, dt: number, height: number) => void;
  turnToward: (current: number, target: number, amount: number) => number;
  enemyLaser: (enemy: any, dt: number) => void;
  enemySpawn: (enemy: any, forcedType?: string | null, amount?: number) => void;
  enemyShoot: (enemy: any, dir: any) => void;
  enemyMelee: (enemy: any) => void;
  resolveCircleCollision: (position: any, radius: number) => void;
  terrainHeight: (x: number, z: number) => number;
  killEnemy: (index: number, enemy: any) => void;
  openPortal: () => void;
}

export class EnemyDirector {
  constructor(private deps: EnemyDirectorDependencies) {}

  spawnWave(ctx: any): void {
