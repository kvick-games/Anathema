import type { Binding, EnemyModelConfig, EnemyTypeConfig, PhysicsConfig, Weapon } from "../core/types.js";

export const enemyModelConfigs: Record<string, EnemyModelConfig> = {
  zealot: {
...
const weaponTemplates: Omit<Weapon, "upgrades">[] = [
...
export function createWeapons(): Weapon[] {
...
export const movementBindings: Binding[] = [
  ["Move Forward", "W"],
  ["Move Back", "S"],
  ["Move Left", "A"],
  ["Move Right", "D"],
...
export const combatBindings: Binding[] = [
...
export const systemBindings: Binding[] = [
  ["Character Menu", "H / F"],
  ["Control Scheme", "M"],
  ["Close Menu", "Esc"],
  ["Repair Kit", "C"],
...
export const statDescriptions: Binding[] = [
