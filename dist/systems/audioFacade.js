...
export function createAudioFacade() {
    ...
    let musicStateKey = "";
    function deckMusicName(snapshot) {
    ...
    function deckMusicSettings(snapshot) {
    ...
    function deckMusicSeed(snapshot) {
    ...
    function updateMusic(snapshot, force = false) {
        if (!musicManager)
            return;
